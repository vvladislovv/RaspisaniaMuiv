...
export async function GET(request: Request): Promise<Response> {
  ...
  if (url.searchParams.get('screens') === '1') {
    // Экраны всех чатов читают одно и то же расписание, и без общего кэша
    // отчёт повторял одни и те же выборки: на одиннадцати чатах 81 обращение
    // к расписанию и 79 к файлам против 21 и 7. Отдача та же, работы меньше.
